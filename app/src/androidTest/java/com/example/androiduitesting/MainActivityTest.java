...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // text_city_name only exists in ShowActivity — if it's visible, the switch worked
    ...
    public void testCityNameConsistency() {
        ...
        // The TextView must show exactly what was added
    ...
    public void testBackButton() {
        ...
        // Press the explicit Back button in ShowActivity
        onView(withId(R.id.button_back)).perform(click());

        // city_list only exists in MainActivity — if it's visible, we're back
